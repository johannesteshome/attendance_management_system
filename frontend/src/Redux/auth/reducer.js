...
export default function authReducer(state = initialState, { type, payload }) {
  switch (type) {
    case types.LOGIN_NURSE_REQUEST ||
      ...
      types.LOGIN_TEACHER_REQUEST ||
      types.LOGIN_STUDENT_REQUEST:
      return {
        ...state,
    ...
    case types.LOGIN_NURSE_SUCCESS ||
      ...
      types.LOGIN_TEACHER_SUCCESS ||
      types.LOGIN_STUDENT_SUCCESS:
    ...
    case types.LOGIN_NURSE_ERROR ||
      ...
      types.LOGIN_TEACHER_ERROR ||
      types.LOGIN_STUDENT_ERROR:
      return {
        ...state,
