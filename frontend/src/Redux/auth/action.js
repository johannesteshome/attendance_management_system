...
export const NurseLogin = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post("http://localhost:5000/nurses/login", data);
    dispatch({
...
export const NurseRegister = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post("http://localhost:5000/nurses/register", data);
    // console.log(res);
    return res.data;
    // dispatch({
...
export const SendPassword = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`http://localhost:5000/admin/password`, data);
    console.log(res, "dispatch");
    return res.data;
  } catch (error) {
    console.log(error);
...
export const TeacherRegister = (data) => async (dispatch) => {
  try {
    ...
    dispatch({
      type: types.REGISTER_TEACHER_ERROR,
      payload: {
        message: error,
      },
    });
...
export const UpdateTeacher = (data, id) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(
      `https://localhost:5000/teachers/${id}`,
      data
    );
    console.log(res);
...
export const UpdateStudent = (data, id) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(
      `https://localhost:5000/students/${id}`,
      data
    );
    console.log(res);
